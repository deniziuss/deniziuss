...
It's a Windows-based diagnostic tool I'm developing to bring different network checks into one place, with a focus on DNS, connectivity and problems that may be related to DPI or network filtering.
